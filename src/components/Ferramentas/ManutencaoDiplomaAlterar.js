    ...
    <div className="container animeLeft ">
      ...
      <div className='content'>
        ...
        <Form onSubmit={handleSubmit(onSubmit)} className="mt-5 ">
          <Form.Row>
            <Input size='lg' lg="12" label='Nome do Aluno' name='name' register={register({ required: true })} value={name} type='text' textoErro={errors.name && "Campo Nome do Aluno é obrigatória"} placeholder='Nome do aluno' onChange={(event) => setName(event.target.value)}></Input>
          </Form.Row>
          <Form.Row>
            <Input size='lg' lg="6" label='CPF' name='cpf' size='lg' register={maskedCPFRef} value={cpf} type='text' placeholder=" Número do CPF" textoErro={errors.cpf && "Campo Cpf é obrigatório"} onChange={(event) => setCpf(event.target.value)}></Input>
          ...
          <Form.Row >
            <Input size='lg' lg="12" label='Nome do Pai' name='nameFather' register={register({ required: true })} value={nameFather} type='text' textoErro={errors.nameFather && "Campo Nome do Pai é obrigatória"} placeholder='Nome do Pai' onChange={(event) => setNameFather(event.target.value)}></Input>
          </Form.Row>

          <Form.Row >
            <Input size='lg' lg="12" label='Nome da Mãe' name='nameMother' register={register({ required: true })} value={nameFather} type='text' textoErro={errors.nameMother && "Campo Nome da Mãe é obrigatória"} placeholder='Nome da Mãe' onChange={(event) => setNameMother(event.target.value)}></Input>
          </Form.Row>

          <Form.Row>
            <Select lg='6' size='lg' label='País' value={country} name='country' register={register({ required: true })} options={['Brasil', 'Português']} textoErro={errors.country && "Campo País é obrigatório"} onChange={({ target }) => setCountry(target.value)}></Select>
          ...
          <Form.Row>
            <Select lg='6' size='lg' label='Cidade' value={city} name='city' register={register({ required: true })} options={['BH', 'Rio']} textoErro={errors.city && "Campo Cidade é obrigatório"} onChange={({ target }) => setCity(target.value)}></Select>
          ...
          <Form.Row>
            <Input size='lg' lg="6" label='Matrícula' name='ra' register={register({ required: true })} value={ra} type='text' textoErro={errors.ra && "Campo Matrícula é obrigatório"} placeholder='Número da Matrícula' onChange={(event) => setRa(event.target.value)}></Input>
          ...
          <Form.Row>
            <Select lg='6' size='lg' label='Instituição' value={institution} name='institution' register={register({ required: true })} options={['UEMG', 'UFMG', 'UFLA']} textoErro={errors.institution && "Campo Instituição é obrigatório"} onChange={({ target }) => setInstitution(target.value)}></Select>
          ...
          <Form.Row>
            <Select lg='6' size='lg' label='Grau do curso' value={level} name='level' register={register({ required: true })} options={['Graduação', 'Pós Graduação', 'Apostila']} textoErro={errors.level && "Campo Grau do Curso  é obrigatório"} onChange={({ target }) => setLevel(target.value)}></Select>
          ...
          <Form.Row>
            <Input size='lg' lg="6" label='Num. de Passaporte' name='passaport' register={register({ required: true })} value={passaport} type='number' textoErro={errors.passaport && "Campo Num. de Passaporte é obrigatório"} onChange={(event) => setPassaport(event.target.value)}></Input>
          ...
          <Form.Row>
          <Input size='lg' lg="6" label='Data Colação De Grau' name='dateGraduation' register={register({ required: true })} value={dateGraduation} type='date' textoErro={errors.dateGraduation && "Campo Data inicial é obrigatória"} onChange={(event) => setDateGraduation(event.target.value)}></Input>
          ...
          <Form.Row>
          <Input size='lg' type='date' lg="6" label='Data Selo' name='sealDate' register={register({ required: true })} value={sealDate} textoErro={errors.lotNumber && "Campo Data Selo é obrigatório"} onChange={(event) => setSealDate(event.target.value)}></Input>
          ...
          <Form.Row>
          <Input size='lg' lg="6" label='Marca' name='brand' register={register({ required: true })} value={brand} textoErro={errors.brand && "Campo Marca é obrigatório"} onChange={(event) => setBrand(event.target.value)}></Input>
          ...
          <Form.Row>
          <Input size='lg' lg="12" label='Complemento' name='complement' register={register({ required: true })} value={complement} textoErro={errors.complement && "Campo Complemento é obrigatório"} onChange={(event) => setComplement(event.target.value)}></Input>
          </Form.Row>
